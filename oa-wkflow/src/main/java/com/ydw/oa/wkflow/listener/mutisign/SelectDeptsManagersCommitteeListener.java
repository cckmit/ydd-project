...
//发送所选部门所有部门领导会签
public class SelectDeptsManagersCommitteeListener extends NoticeListener implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		...
		for (String dept : depts) {
			String user = authFeignService.getDepartManagerByDeptName(dept).getResult();
			usrs.add(user);
		}
		delegateTask.setVariable("assigneeManagersList", usrs);
	}
}
