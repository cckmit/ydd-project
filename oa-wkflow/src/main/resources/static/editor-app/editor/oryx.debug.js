...
ORYX.CONFIG.ROOT_PATH =					"oa-wkflow/editor/"; //TODO: Remove last slash!!
 ...
 * Regular Config
 */	
ORYX.CONFIG.SERVER_HANDLER_ROOT = 			"oa-wkflow/service";
...
ORYX.CONFIG.ORYX_NEW_URL =					"/oa-wkflow/new";	
...
function init() {
    ...
    // Else fetch the model from server and display editor
		...
		var modelUrl = "/oa-wkflow/service/model/" + modelId + "/json";
